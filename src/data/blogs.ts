  ...
  <table style="width:100%; border-collapse: collapse; margin-top:16px;">
    <thead>
      <tr style="background:#f5f5f5;">
        <th style="border:1px solid #ddd; padding:10px; text-align:left;">Country</th>
    ...
    <tbody>
      <tr>
        <td style="border:1px solid #ddd; padding:10px;">UK</td>
        <td style="border:1px solid #ddd; padding:10px;">$15,000 – $35,000</td>
        <td style="border:1px solid #ddd; padding:10px;">$10,000 – $18,000</td>
        <td style="border:1px solid #ddd; padding:10px;">$25,000 – $53,000</td>
      </tr>
      <tr>
        <td style="border:1px solid #ddd; padding:10px;">USA</td>
        <td style="border:1px solid #ddd; padding:10px;">$20,000 – $50,000</td>
        <td style="border:1px solid #ddd; padding:10px;">$12,000 – $20,000</td>
        <td style="border:1px solid #ddd; padding:10px;">$32,000 – $70,000</td>
      </tr>
      <tr>
        <td style="border:1px solid #ddd; padding:10px;">Canada</td>
        <td style="border:1px solid #ddd; padding:10px;">$15,000 – $30,000</td>
        <td style="border:1px solid #ddd; padding:10px;">$10,000 – $15,000</td>
        <td style="border:1px solid #ddd; padding:10px;">$25,000 – $45,000</td>
      </tr>
      <tr>
        <td style="border:1px solid #ddd; padding:10px;">Australia</td>
        <td style="border:1px solid #ddd; padding:10px;">$13,000 – $28,000</td>
        <td style="border:1px solid #ddd; padding:10px;">$14,000 – $22,000</td>
